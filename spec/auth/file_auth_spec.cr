...
describe Google::Cloud::Bigquery::FileAuth do
  describe "#get_token" do
    it "succeeds" do
      ...
      auth = Google::Cloud::Bigquery::FileAuth.new(file_path: FileAuthHelper.client_auth_file, scopes: "TEST_GOOGLE_API_SCOPE")
    ...
    describe "failure" do
      it "api error" do
        ...
        auth = Google::Cloud::Bigquery::FileAuth.new(file_path: FileAuthHelper.client_auth_file, scopes: "TEST_GOOGLE_API_SCOPE", sub: "admin@example.com")
      ...
      it "auth file does not have required fields" do
        auth = Google::Cloud::Bigquery::FileAuth.new(file_path: FileAuthHelper.incomplete_client_auth_file, scopes: "TEST_GOOGLE_API_SCOPE", sub: "admin2@example.com")
