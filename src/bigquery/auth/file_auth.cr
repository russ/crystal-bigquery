  ...
  module Cloud
    module Bigquery
      class FileAuth
        ...
        def initialize(@file_path : String, @scopes : String | Array(String), @sub : String = "", @user_agent : String = "Crystal-BigQuery")
          @client_secret = process_auth_file
        end

        def get_token : Token
          Google::Cloud::Bigquery::Auth.new(issuer: issuer, signing_key: signing_key, scopes: scopes, user_agent: user_agent, sub: sub).get_token
        end
